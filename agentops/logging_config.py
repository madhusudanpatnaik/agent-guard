...
message; this attaches a single stdout handler under the ``agentops`` namespace
...
def configure_logging(level: str = "INFO", as_json: bool = True) -> None:
    ...
    if getattr(logger, "_agentops_configured", False):
        return
    ...
    logger._agentops_configured = True  # type: ignore[attr-defined]
