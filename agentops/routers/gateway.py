...
def authorize(
    ...
    with span("gateway.authorize", **{"agentops.agent": agent.name,
                                      "agentops.action": body.action_type,
                                      "agentops.resource": body.resource}):
...
def publish(
    ...
    try:
        with span("gateway.publish", **{"agentops.agent": agent.name,
                                        "agentops.topic": body.topic}):
