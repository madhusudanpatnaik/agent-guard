"""Command-line entrypoint: ``agentops serve|seed|verify``."""
...
def _rotate_vault_key(args: argparse.Namespace) -> int:
    ...
    print("Now set AGENTOPS_VAULT_KEY to the new value and restart the service.")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    rotate.add_argument("--new-key", required=True, help="The new AGENTOPS_VAULT_KEY value")
