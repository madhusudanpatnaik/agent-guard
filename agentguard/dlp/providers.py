...
The built-in :func:`~agentguard.dlp.scanner.scan_payload` is the always-on core.
...
* **LLM-guard** (on by default): prompt-injection / jailbreak / tool-abuse
  detectors from :mod:`agentguard.dlp.llm_guard`.
...
_log = logging.getLogger("agentguard.dlp.providers")
