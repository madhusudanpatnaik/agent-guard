...
the concrete evidence AgentGuard already records in its tamper-evident ledger, and
...
This maps AgentGuard capabilities to control families; it is decision-support for
...
class Control:
    ...
    how: str           # how AgentGuard satisfies it
...
def build_report(db: Session, org: Organization, framework: str,
    ...
    for control in fw["controls"]:
        ...
        controls_out.append({
            ...
            "requirement": control.requirement, "agentguard_control": control.how,
    ...
    return {
        ...
        "disclaimer": ("This report maps AgentGuard enforcement capabilities to control "
...
def render_markdown(report: dict) -> str:
    ...
    for c in report["controls"]:
        ...
        lines += [
            ...
            f"- **AgentGuard control:** {c['agentguard_control']}",
