...
Every governed decision is committed as an :class:`~agentguard.models.AuditRecord`
...
_audit_log = logging.getLogger("agentguard.audit")
...
# Arbitrary but stable 64-bit key identifying "the AgentGuard ledger" to Postgres.
