...
_log = logging.getLogger("agentguard.auth")
...
_DUMMY_HASH = hash_password("agentguard-constant-time-equalizer")
...
def oidc_callback(
    ...
    """Complete SSO: validate the IdP ID token and issue an AgentGuard session."""
    settings = get_settings()
