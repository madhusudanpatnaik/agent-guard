...
def prometheus_metrics(
    ...
    metrics = [
        ("agentguard_agents_total", "Total registered agents", "gauge", s.agents_total),
        ("agentguard_agents_active", "Currently active agents", "gauge", s.agents_active),
        ("agentguard_roles_total", "Total roles defined", "gauge", s.roles_total),
        ("agentguard_policies_total", "Total policies defined", "gauge", s.policies_total),
        ("agentguard_connectors_total", "Total connectors registered", "gauge", s.connectors_total),
        ("agentguard_connectors_active", "Enabled connectors", "gauge", s.connectors_active),
        ("agentguard_decisions_total", "Total governance decisions", "counter", s.decisions_total),
        ("agentguard_decisions_allowed", "Decisions allowed", "counter", s.decisions_allowed),
        ("agentguard_decisions_denied", "Decisions denied", "counter", s.decisions_denied),
        ("agentguard_approvals_pending", "Approvals awaiting a human", "gauge", s.approvals_pending),
        ("agentguard_dlp_incidents", "Actions with DLP findings", "counter", s.dlp_incidents),
        ("agentguard_ledger_valid", "Ledger integrity (1=intact)", "gauge",
         1 if s.ledger_valid else 0),
        ("agentguard_ledger_length", "Audit records for this org", "gauge", s.ledger_length),
    ]
    lines: list[str] = []
